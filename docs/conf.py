...
# From: https://github.com/kennethreitz/requests/blob/master/docs/conf.py
# Insert django_extensions_shell  path into the system.
...
project = u'django-extensions-shell'
...
# built documents.
#
from django_extensions_shell import __version__
...
htmlhelp_basename = 'django-extensions-shelldoc'
